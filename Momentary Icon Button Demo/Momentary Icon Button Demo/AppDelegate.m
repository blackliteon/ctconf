...
@property (strong, nonatomic) CTIconMomentaryButtonController *buttonController;
...
{
    NSString *defaultConfPath = [[NSBundle mainBundle] pathForResource:@"button" ofType:@"conf"];
    ...
    self.buttonController = [[CTIconMomentaryButtonController alloc] initWithImageTemplatePathPropertyName:@"imageTemplatePath" stylesPropertyName:@"pushButtonStyles" backgroudColorProperty:nil];
